...
case 'fb' :
  ...
  const msg = '*ᴅᴜʟᴀ* MD FB Downloder\n\n*📥Quality එක තෝරන්න්න📤*'
const buttons = [
...
mediaType:1,
mediaUrl: 'https://i.ibb.co/8gc5hCR/20220813-181852.jpg',
sourceUrl: "https://i.ibb.co/8gc5hCR/20220813-181852.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
case 'alive': {
    ...
    let buttonMessage = {
    image: { url: `https://i.ibb.co/8gc5hCR/20220813-181852.jpg` },
    caption: `╔═════❬🧸𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝙼𝚁.ᴅᴜʟᴀ 🧸❭
...
*👩🏻‍🦳මම ᴏɴʟɪɴᴇ මොකද්ද මගෙන් කෙරෙන්න ඔනි*

*🤷‍♀️How can I help you?😉*

*⚙️මාගෙ විදාන ලබාගැනීමට (.ᴍᴇɴᴜ) සදහන් කරන්න✌️*

*☃️මාසමග ගනුදෙනු කල ඔබට සුබ දවසක්🥰*
